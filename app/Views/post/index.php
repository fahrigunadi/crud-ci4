                        ...
                        <?php foreach($posts as $key => $post) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo base_url("posts/{$post['id']}/edit") ?>" class="btn btn-sm btn-primary">EDIT</a>
                                    <a href="<?php echo base_url("posts/{$post['id']}/delete") ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                </td>
                            </tr>
